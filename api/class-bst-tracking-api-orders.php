...
class BS_Shipment_Tracking_API_Orders extends BS_Shipment_Tracking_API_Resource
{
	...
	public function get_order($id, $fields = null)
	{
		...
		$order_data['bs_ship_track']['woocommerce']['trackings'][] = array(
			'tracking_provider' => get_post_meta($order->get_id(), '_bst_tracking_provider', true),
			'tracking_number' => get_post_meta($order->get_id(), '_bst_tracking_number', true),
			'tracking_ship_date' => get_post_meta($order->get_id(), '_bst_tracking_shipdate', true)
		);
